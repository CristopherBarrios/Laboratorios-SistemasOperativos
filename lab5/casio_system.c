...
// Estos son configuracion de procesos, estos incuyen maximos y minimos
...
// Tiene un valor numero str, ademas este interpreta su numero como un numero entero
...
// imprime la configuracion de los procesos
...
// esta configuracion limpia los procesos por cada task
...
// este obttiene un procesos puntual
...
// Esta se encarga de extraer todos los procesos
...
// Inicia la simulacion y la termina
...
int main(int argc, char *argv[])
{
	...
	for(i=0;i<casio_tasks_num;i++){
		...
		// Este nos dota de informacion con casio_task
